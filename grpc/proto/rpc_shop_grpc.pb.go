...
func (c *shopServiceClient) CheckShopPermission(ctx context.Context, in *CheckShopPermissionReq, opts ...grpc.CallOption) (*CheckShopPermissionRes, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.ShopService/CheckShopPermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shopServiceClient) CreateShop(ctx context.Context, in *CreateShopReq, opts ...grpc.CallOption) (*CreateShopRes, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.ShopService/CreateShop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shopServiceClient) GetShopByProfileId(ctx context.Context, in *GetShopByProfileIdReq, opts ...grpc.CallOption) (*GetShopByProfileIdRes, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.ShopService/GetShopByProfileId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ShopService_CheckShopPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ShopService/CheckShopPermission",
	}
...
func _ShopService_CreateShop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ShopService/CreateShop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopService_GetShopByProfileId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ShopService/GetShopByProfileId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
