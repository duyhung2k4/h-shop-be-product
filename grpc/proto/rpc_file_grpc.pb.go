...
func (c *fileServiceClient) InsertFile(ctx context.Context, opts ...grpc.CallOption) (FileService_InsertFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[0], "/proto.FileService/InsertFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fileServiceClient) GetFileIdsWithProductId(ctx context.Context, in *GetFileIdsWithProductIdReq, opts ...grpc.CallOption) (*GetFileIdsWithProductIdRes, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.FileService/GetFileIdsWithProductId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) InsertAvatarProduct(ctx context.Context, in *InsertAvatarProductReq, opts ...grpc.CallOption) (*InsertAvatarProductRes, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.FileService/InsertAvatarProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FileService_GetFileIdsWithProductId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.FileService/GetFileIdsWithProductId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FileService_InsertAvatarProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.FileService/InsertAvatarProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
